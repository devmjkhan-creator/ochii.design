...
const Footer = () => {
  return (
    ...
    <div data-scroll  data-scroll-speed="0.6" className='relative w-full h-screen z-40 bg-[#F1F1F1] mt-[-40vh] rounded-2xl'>
      <div className='w-full h-full flex flex-col pt-[8vh] px-[4vw]'>
        {/* Top section */}
        <div className='relative w-full flex-1 flex'>
          {/* Left side */}
          <div className='absolute left-0 w-1/2 h-full flex flex-col'>
            <h1 className='font-["Oswald"] uppercase text-[100px] tracking-tighter leading-none font-bold'>eye- <br />opening</h1>
          </div>
          {/* Right side */}
          <div className='absolute right-0 w-1/2 h-full items-start'>
          <h1 className='font-["Oswald"] uppercase text-5xl p-4 tracking-tighter font-bold text-[100px] ml-[-1.5vw]'>Presentations</h1>
            <div className='w-full mt-[3vh] flex flex-row'>

        {/* {1st Div} */}
                <div className='w-[50%] h-full font-light flex gap-8 flex-col'>
        ...
        {/* {2nd div} */}
            ...
            <div className='w-[50%] h-full mr-[3vw]'>
            <div className='flex flex-col items-end gap-4 pt-[20vh]'>
            <p className='mr-[4.2vw]'>M:</p>
            <div className='flex flex-col '>
            <a href="#">Home</a>
            <a href="#">Services</a>
            <a href="#">Our work</a>
        ...
        {/* Bottom section */}
        <div className=' w-full h-[15vh] flex flex-row '>
            {/* {Section left} */}
            ...
            {/* {Section right} */}
            <div className='w-[50%]  h-full flex flex-row items-baseline justify-between text-[#C6C6C6] font-light'>
                <p>© ochi design 2026. Legal Terms</p>
                <p>Website by Obys </p>
            </div>
        </div>
      </div>
